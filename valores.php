...
<body>
    ...
    <main>
        ...
        <br>
        <div class="card text-white bg-primary mb-3 container" style="max-width: 18rem;">
            <div class="card-header">Serviços e Valores</div>
            <div class="card-body">
                <p class="card-text">Formatação - R$80,00.</p>
                <p class="card-text">Limpeza de computadores/notebooks - R$50,00.</p>
                <p class="card-text">Instalação de Softwares - à combinar.</p>
                <p class="card-text">Configurar roteador - R$80,00</p>
                <p class="card-text">Outros Serviços - à combinar.</p>
            </div>
        </div>
    </main>
    <footer>
